...
//    });
    ...
    bindFastGo: function () {
      var _this = this;
      var html = $('<li class="ui-pagging-lis ui-paging-toolbar"><span>快速翻页</span><input type="text" class="inp-gofast"/><div class="btn-dogo btn btn-primary btn-sm">确认</div></li>');
